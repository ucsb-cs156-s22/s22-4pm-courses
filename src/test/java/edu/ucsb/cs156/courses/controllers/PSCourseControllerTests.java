...
public class PSCourseControllerTests extends ControllerTestCase {
    ...
    public void api_courses__user_logged_in__returns_a_courses_that_exists() throws Exception {
        ...
        when(pscourseRepository.findByIdAndUser(eq(7L), eq(u))).thenReturn(Optional.of(course1));
        ...
        verify(pscourseRepository, times(1)).findByIdAndUser(7L, u);
    ...
    public void api_courses__user_logged_in__search_for_courses_that_does_not_exist() throws Exception {
        ...
        when(pscourseRepository.findByIdAndUser(eq(7L), eq(u))).thenReturn(Optional.empty());
    ...
    public void api_courses__admin_logged_in__returns_a_courses_that_exists_using_psid() throws Exception {
        ...
        when(pscourseRepository.findAllByPsId(13L)).thenReturn(expectedCourses);
        ...
        verify(pscourseRepository, times(1)).findAllByPsId(13L);
    ...
    public void api_courses__user_logged_in__returns_a_courses_that_exists_using_psid() throws Exception {
        ...
        ArrayList<PSCourse> expectedCourses = new ArrayList<>();
        expectedCourses.addAll(Arrays.asList(course1, course2));
        when(pscourseRepository.findAllByPsIdAndUser(13L, u)).thenReturn(expectedCourses);
        ...
        verify(pscourseRepository, times(1)).findAllByPsIdAndUser(13L, u);
        String expectedJson = mapper.writeValueAsString(expectedCourses);
        String responseString = response.getResponse().getContentAsString();
        assertEquals(expectedJson, responseString);
    }
    ...
    public void api_courses__user_logged_in__search_for_courses_that_belongs_to_another_user() throws Exception {
        ...
        when(pscourseRepository.findByIdAndUser(eq(13L), eq(otherUser))).thenReturn(Optional.of(otherUsersCourses));
        ...
        verify(pscourseRepository, times(1)).findByIdAndUser(13L, u);
        Map<String, Object> json = responseToJson(response);
        assertEquals("EntityNotFoundException", json.get("type"));
    ...
    public void api_courses__admin_logged_in__search_for_course_that_belongs_to_another_user() throws Exception {
        ...
        when(pscourseRepository.findById(eq(27L))).thenReturn(Optional.of(otherUsersCourses));
        ...
        verify(pscourseRepository, times(1)).findById(27L);
    ...
    public void api_courses__admin_logged_in__search_for_course_that_does_not_exist() throws Exception {
        ...
        when(pscourseRepository.findById(eq(29L))).thenReturn(Optional.empty());
        ...
        verify(pscourseRepository, times(1)).findById(29L);
        Map<String, Object> json = responseToJson(response);
        assertEquals("EntityNotFoundException", json.get("type"));
    ...
    public void api_courses_admin_all__admin_logged_in__returns_all_courses() throws Exception {
        ...
        when(pscourseRepository.findAll()).thenReturn(expectedCourses);
        ...
        verify(pscourseRepository, times(1)).findAll();
        String expectedJson = mapper.writeValueAsString(expectedCourses);
        String responseString = response.getResponse().getContentAsString();
        assertEquals(expectedJson, responseString);
    }
    ...
    public void api_courses_all__user_logged_in__returns_only_courses_for_user() throws Exception {
        ...
        when(pscourseRepository.findAllByUserId(thisUser.getId())).thenReturn(expectedCourses);
        ...
        verify(pscourseRepository, times(1)).findAllByUserId(eq(thisUser.getId()));
        String expectedJson = mapper.writeValueAsString(expectedCourses);
        String responseString = response.getResponse().getContentAsString();
        assertEquals(expectedJson, responseString);
    }
    ...
    public void api_courses_post__user_logged_in() throws Exception {
        ...
        when(pscourseRepository.save(eq(expectedCourses))).thenReturn(expectedCourses);
        ...
        // assert
        verify(pscourseRepository, times(1)).save(expectedCourses);
        String expectedJson = mapper.writeValueAsString(expectedCourses);
        String responseString = response.getResponse().getContentAsString();
        assertEquals(expectedJson, responseString);
    }
    ...
    public void api_courses__user_logged_in__delete_course() throws Exception {
        ...
        when(pscourseRepository.findByIdAndUser(eq(15L), eq(u))).thenReturn(Optional.of(ps1));
        ...
        // assert
        verify(pscourseRepository, times(1)).findByIdAndUser(15L, u);
        verify(pscourseRepository, times(1)).delete(ps1);
        Map<String, Object> json = responseToJson(response);
    ...
    public void api_courses__user_logged_in__delete_course_that_does_not_exist() throws Exception {
        ...
        PSCourse ps1 = PSCourse.builder().enrollCd("08250").psId(13L).user(u).id(15L).build();
        when(pscourseRepository.findByIdAndUser(eq(15L), eq(otherUser))).thenReturn(Optional.of(ps1));
    ...
    public void api_courses__user_logged_in__cannot_delete_delete_belonging_to_another_user() throws Exception {
        ...
        when(pscourseRepository.findById(eq(31L))).thenReturn(Optional.of(ps1));
        ...
        // assert
        verify(pscourseRepository, times(1)).findByIdAndUser(31L, u);
        Map<String, Object> json = responseToJson(response);
    ...
    public void api_courses__admin_logged_in__delete_course() throws Exception {
        ...
        when(pscourseRepository.findById(eq(16L))).thenReturn(Optional.of(ps1));
        ...
        // assert
        verify(pscourseRepository, times(1)).findById(16L);
        verify(pscourseRepository, times(1)).delete(ps1);
    ...
    public void api_courses__admin_logged_in__cannot_delete_course_that_does_not_exist() throws Exception {
        ...
        when(pscourseRepository.findById(eq(17L))).thenReturn(Optional.empty());
        ...
        // assert
        verify(pscourseRepository, times(1)).findById(17L);
        Map<String, Object> output = responseToJson(response);
    ...
    public void api_courses__user_logged_in__put_course() throws Exception {
        ...
        when(pscourseRepository.findByIdAndUser(eq(67L), eq(u))).thenReturn(Optional.of(ps1));
        ...
        // assert
        verify(pscourseRepository, times(1)).findByIdAndUser(67L, u);
        verify(pscourseRepository, times(1)).save(correctCourses); // should be saved with correct user
        String responseString = response.getResponse().getContentAsString();
    ...
    public void api_courses__user_logged_in__cannot_put_course_that_does_not_exist() throws Exception {
        ...
        when(pscourseRepository.findByIdAndUser(eq(67L), eq(u))).thenReturn(Optional.empty());
    ...
    public void api_courses__user_logged_in__cannot_put_course_for_another_user() throws Exception {
        ...
        when(pscourseRepository.findByIdAndUser(eq(31L), eq(otherUser))).thenReturn(Optional.of(ps1));
    ...
    public void api_schedules__admin_logged_in__put_schedule() throws Exception {
        ...
        when(pscourseRepository.findById(eq(77L))).thenReturn(Optional.of(ps1));
        ...
        // assert
        verify(pscourseRepository, times(1)).findById(77L);
        verify(pscourseRepository, times(1)).save(correctCourses);
        String responseString = response.getResponse().getContentAsString();
        assertEquals(expectedJson, responseString);
    }
    ...
    public void api_courses__admin_logged_in__cannot_put_course_that_does_not_exist() throws Exception {
        ...
        when(pscourseRepository.findById(eq(77L))).thenReturn(Optional.empty());
