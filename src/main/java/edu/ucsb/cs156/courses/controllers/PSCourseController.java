...
public class PSCourseController extends ApiController {
    ...
    public Iterable<PSCourse> allUsersCourses() {
        Iterable<PSCourse> courses = pscourseRepository.findAll();
        return courses;
    }
    ...
    public Iterable<PSCourse> thisUsersCourses() {
        ...
        Iterable<PSCourse> courses = pscourseRepository.findAllByUserId(currentUser.getUser().getId());
        return courses;
    }
    ...
    public Iterable<PSCourse> allCoursesForPsId(
        ...
        Iterable<PSCourse> courses = pscourseRepository.findAllByPsId(psId);
        return courses;
    }
    ...
    public Iterable<PSCourse> thisUsersCoursesForPsId(
        ...
        Iterable<PSCourse> courses = pscourseRepository.findAllByPsIdAndUser(psId, currentUser);
        return courses;
    }
    ...
    public PSCourse getCourseById_admin(
        ...
        PSCourse courses = pscourseRepository.findById(id)
    ...
    public PSCourse getCourseById(
            @ApiParam("id") @RequestParam Long id) {
        User currentUser = getCurrentUser().getUser();
        PSCourse courses = pscourseRepository.findByIdAndUser(id, currentUser)
            .orElseThrow(() -> new EntityNotFoundException(PSCourse.class, id));
    ...
    public PSCourse postCourses(
        ...
        PSCourse savedCourses = pscourseRepository.save(courses);
        return savedCourses;
    }
    ...
    public Object deleteCourses_Admin(
          ...
          pscourseRepository.delete(courses);
    ...
    public PSCourse putCourseById_admin(
          ...
          pscourseRepository.save(courses);
